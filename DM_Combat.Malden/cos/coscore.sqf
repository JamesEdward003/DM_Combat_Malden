...
if (!(server getvariable _trigID)) exitwith {_isActive=false;};
		...
		_direction = _tempPos getDir _connectedRoad;
...
//		0=[markerText _mkr,_population] spawn BIS_fnc_infoText;
		0=[[markerText _mkr,1,4,1],[_population,1,4,1]] spawn BIS_fnc_EXP_camp_SITREP;
		};
