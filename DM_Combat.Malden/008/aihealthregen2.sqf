...
_unit addEventHandler ["Hit",{
	...
	if (alive _unit) then 
	{
		if (_damage > 0) then
		{
			...
			//hintSilent parseText format["<t size='1' font='PuristaBold' color='#ff0000'>Loadout Saved!</t>"];
			hintSilent parseText format["<t size='1' font='PuristaBold' color='#FFFF00'>Health: %1-%2</t>",name _unit, damage _unit];
			sleep 0.1;
		};
