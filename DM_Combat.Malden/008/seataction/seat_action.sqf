...
// "008\SeatAction\seat_action.sqf"
//////////////////////////////////////////////////////////////////
 ...
 {//Helis with 10+ seats with gunner
 ...
 If (typeOf _x in ["B_Heli_Light_01_F","O_Heli_Light_02_F","O_Heli_Light_02_v2_F","O_Heli_Light_02_unarmed_F","Ka60_PMC","Mi17_Civilian","Mi17_medevac_CDF","Mi17_medevac_Ins","Mi17_medevac_RU","UH60M_MEV_EP1"]) then 
 {//Helis with 8+ seats no gunner
 nul = _x addAction ["To Pilot's Seat","008\SeatAction\switchseat.sqf",["pilot"],5,false,true,"","player in (assignedVehicle _target) and driver _target != player"];
 nul = _x addAction ["To Backseat","008\SeatAction\switchseat.sqf",["back"],5,false,true,"","driver _target == player"];
 };

 If (typeOf _x in ["AH6J","AH6J_EP1","AH6X_EP1","GNT_C185","GNT_C185C","GNT_C185F","GNT_C185R","GNT_C185U","MAF_GazelleHOTD"]) then 
 {//Helis with 2-4 seats no gunner
 nul = _x addAction ["To Pilot's Seat","008\SeatAction\switchseat.sqf",["pilot"],5,false,true,"","player in (assignedVehicle _target) and driver _target != player"];
 nul = _x addAction ["To Backseat","008\SeatAction\switchseat.sqf",["back"],5,false,true,"","driver _target == player"];
 };

 If (typeOf _x in ["B_Heli_Attack_01_dynamicLoadout_F","AH1Z","AH64D","AH64D_EP1","BAF_Apache_AH1_D","Ka52","Ka52Black","Ka137_MG_PMC"]) then 
 {//Helis with 2 seats including gunner
 nul = _x addAction ["To Pilot's Seat","008\SeatAction\switchseat.sqf",["pilot"],5,false,true,"","player in (assignedVehicle _target) and driver _target != player"];
 nul = _x addAction ["To Gunner's Seat","008\SeatAction\switchseat.sqf",["gunner"],5,false,true,"","driver _target == player"];
 };

 If (typeOf _x in ["MH6J_EP1"]) then 
 {//Helis with <7 seats no gunner
 nul = _x addAction ["To Pilot's Seat","008\SeatAction\switchseat.sqf",["pilot"],5,false,true,"","player in (assignedVehicle _target) and driver _target != player"];
 nul = _x addAction ["To Backseat","008\SeatAction\switchseat.sqf",["back"],5,false,true,"","driver _target == player"];
 };
 } forEach (vehicles);