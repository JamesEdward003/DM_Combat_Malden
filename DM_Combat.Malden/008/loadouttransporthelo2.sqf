...
hintSilent parseText format["<t size='1' font='PuristaBold' color='#FFFF00'>%1 changing loadout...</t>", _vehicleName];
...
hintSilent parseText format["<t size='1' font='PuristaBold' color='#FFFF00'>%1 loadout changed!</t>", _vehicleName];
